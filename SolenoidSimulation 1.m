...
Bx=Bx+sright*flip(Bx,2);
By=By+sright*flip(By,2);
Bz=Bz+sright*flip(Bz,2);
...
clear alpha2 b beta beta2 bx by bz bxy cpb E eps i j K k2 mu0 r2 rho x z zp gridheight gridwidth sradius ssize C zgap sright
% imagesc(xc,yc,log10(B))
imagesc(xc,yc,B)
set(gca,'YDir','normal')
colorMap = parula(512);
colormap(colorMap);
